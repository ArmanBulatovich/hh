...
import { Box, Button, Input, InputGroup, InputRightElement, Select, Text, } from "@chakra-ui/react";
...
export const AllDocuments = () => {
  ...
  const { data: documentsData, isLoading: documentsLoading } = useQuery("documents", () => getAllDocuments())

  return (
    <Box>
      <Box display="flex">
        {documentsLoading ? (<Text textAlign="center" mt="30px">Loading...</Text>) : (
          documentsData && documentsData.data.length === 0 ? (<Text>No documents</Text>) : (
